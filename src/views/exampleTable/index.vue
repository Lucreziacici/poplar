<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="时间" prop="id"  sortable="custom" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="名称"   align="center">
        <template slot-scope="scope">
          <template v-if="scope.row.edit">
            <el-input v-model="scope.row.content_short" class="edit-input" size="small"/>
            <el-button class="cancel-btn" size="mini" icon="el-icon-refresh" type="warning" @click="cancelEdit(scope.row)">cancel</el-button>
          </template>
          <span  @click="scope.row.edit=!scope.row.edit" v-else>{{ scope.row.content_short}}</span>
        </template>
        
      </el-table-column>
      <el-table-column label="内容" show-overflow-tooltip="true" width="150px"  align="center">
        <template slot-scope="scope">
      ...
      <el-table-column v-if="showReviewer" label="审核人"  align="center">
        <template slot-scope="scope">
